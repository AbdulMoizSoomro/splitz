...
describe('CreateGroupModal', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    queryClient.clear();
    useAuthStore.setState({ user: { id: '1', username: 'testuser', email: 'test@example.com' }, token: 'fake-token' });
  });
  ...
  it('calls createGroup and addMember on submit', async () => {
    ...
    vi.mocked(groupService.createGroup).mockResolvedValue({ id: 1, name: 'Test Group' } as unknown as Group);
