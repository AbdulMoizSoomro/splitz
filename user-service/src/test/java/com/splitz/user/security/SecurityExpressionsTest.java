...
class SecurityExpressionsTest {
    ...
    void isOwnerWhenPrincipalIsEntity() {
        ...
        UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(saved, null,
    ...
    void returnsFalseForDifferentUser() {
        ...
        UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(a, null, a.getAuthorities());
        SecurityContextHolder.getContext().setAuthentication(auth);
