 ...
 * Tests custom query methods and repository operations.
 */
@DataJpaTest
...
class FriendshipRepositoryTest {
    ...
    private Friendship createAndPersistFriendship(User requester, User addressee, FriendshipStatus status) {
    ...
    class FindByRequesterOrAddresseeTests {
        ...
        void shouldFindAllFriendshipsForUser() {
            ...
            // When
            List<Friendship> aliceFriendships = friendshipRepository.findByRequesterOrAddressee(alice, alice);
    ...
    class FindByUserAndStatusTests {
        ...
        void shouldFindByUserAndStatus() {
            ...
            // When
            List<Friendship> acceptedFriendships = friendshipRepository.findByUserAndStatus(alice,
    ...
    class FindByAddresseeAndStatusTests {
        ...
        void shouldFindPendingRequestsReceivedByUser() {
            ...
            createAndPersistFriendship(charlie, alice, FriendshipStatus.PENDING); // Alice receives from Charlie
            createAndPersistFriendship(alice, bob, FriendshipStatus.PENDING); // Alice sends to Bob (not counted)
            entityManager.clear();

            // When
            List<Friendship> pendingRequests = friendshipRepository.findByAddresseeAndStatus(alice,
        ...
        void shouldReturnPaginatedResults() {
            ...
            // When
            Page<Friendship> page = friendshipRepository.findByAddresseeAndStatus(
    ...
    class FindByRequesterAndStatusTests {
        ...
        void shouldFindPendingRequestsSentByUser() {
            ...
            createAndPersistFriendship(alice, charlie, FriendshipStatus.PENDING); // Alice sends to Charlie
            createAndPersistFriendship(bob, alice, FriendshipStatus.PENDING); // Alice receives (not counted)
            entityManager.clear();

            // When
            List<Friendship> sentRequests = friendshipRepository.findByRequesterAndStatus(alice,
                    FriendshipStatus.PENDING);
    ...
    class FindAcceptedFriendshipsTests {
        ...
        void shouldReturnPaginatedAcceptedFriendships() {
            ...
            // When
            Page<Friendship> page = friendshipRepository.findAcceptedFriendships(alice, PageRequest.of(0, 1));
