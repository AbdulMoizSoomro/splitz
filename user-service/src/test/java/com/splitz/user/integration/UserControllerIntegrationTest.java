...
/**
 * Integration tests for UserController that test all endpoints end-to-end with a running embedded
...
class UserControllerIntegrationTest {
  ...
  void setUp() {
    ...
    User testUser = new User("Test", "testuser", passwordEncoder.encode("password123"), userRoles);
  ...
  private String authenticateAndGetToken(String username, String password) {
    ...
    ResponseEntity<JwtResponse> authResponse =
        restTemplate.postForEntity(baseUrl + "/authenticate", request, JwtResponse.class);
  ...
  /**
   * Helper method to create a test User map (to ensure password is sent despite WRITE_ONLY
   * annotation on DTO)
   */
  ...
  void testAuthentication_Success() {
    ...
    ResponseEntity<JwtResponse> response =
        restTemplate.postForEntity(baseUrl + "/authenticate", authRequest, JwtResponse.class);
  ...
  void testAuthentication_InvalidCredentials() {
    ...
    ResponseEntity<String> response =
        restTemplate.postForEntity(baseUrl + "/authenticate", authRequest, String.class);

    // Assert - Controller returns 500 for auth failures
    assertThat(response.getStatusCode())
        .isIn(HttpStatus.INTERNAL_SERVER_ERROR, HttpStatus.FORBIDDEN);
  }
  ...
  void testCreateUser_DuplicateUsername() {
    ...
    java.util.Map<String, Object> firstUser =
        createTestUserMap("uniqueuser1", "unique1@example.com");
    ResponseEntity<String> firstResponse =
        restTemplate.postForEntity(baseUrl + "/users", firstUser, String.class);
    assertThat(firstResponse.getStatusCode()).isEqualTo(HttpStatus.CREATED);

    // Try to create duplicate username
    java.util.Map<String, Object> duplicateUser =
        createTestUserMap("uniqueuser1", "different@example.com");

    // Act
    ResponseEntity<String> response =
        restTemplate.postForEntity(baseUrl + "/users", duplicateUser, String.class);
  ...
  void testCreateUser_DuplicateEmail() {
    // Arrange - Create first user
    java.util.Map<String, Object> firstUser =
        createTestUserMap("uniqueuser2", "unique2@example.com");
    ResponseEntity<String> firstResponse =
        restTemplate.postForEntity(baseUrl + "/users", firstUser, String.class);
    assertThat(firstResponse.getStatusCode()).isEqualTo(HttpStatus.CREATED);
    ...
    java.util.Map<String, Object> duplicateUser =
        createTestUserMap("differentuser", "unique2@example.com");
  ...
  void testCreateUser_BlankUsername() {
    ...
    // Act
    ResponseEntity<String> response =
        restTemplate.postForEntity(baseUrl + "/users", invalidUser, String.class);
  ...
  void testGetAllUsers_Success() {
    // Arrange - Authenticate as admin user (only ADMIN can get all users)
    String token = authenticateAndGetToken("adminuser", "admin123");
  ...
  void testGetUserById_Success() {
    ...
    // Act
    ResponseEntity<Void> response =
        restTemplate.exchange(baseUrl + "/users/" + userId, HttpMethod.GET, request, Void.class);
  ...
  void testGetUserById_NotFound() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            baseUrl + "/users/" + nonExistentId, HttpMethod.GET, request, String.class);
  ...
  void testUpdateUser_Success() {
    // Arrange - Admin can update any user
    Long userId = testUserId != null ? testUserId : 1L;
    java.util.Map<String, Object> updateMap = new java.util.HashMap<>();
    updateMap.put("id", userId);
    updateMap.put("username", "testuser"); // Keep original username
    updateMap.put("email", "testuser@example.com"); // Keep original email
    updateMap.put("firstName", "UpdatedTest"); // Updated firstName
    updateMap.put("lastName", "User");
    updateMap.put("password", "newpassword123");

    // Use admin authentication to update any user
    String token = authenticateAndGetToken("adminuser", "admin123");
    HttpHeaders headers = createAuthHeaders(token);
    ...
    ResponseEntity<UserDTO> response =
        restTemplate.exchange(baseUrl + "/users/" + userId, HttpMethod.PUT, request, UserDTO.class);

    // Assert
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isNotNull();
    if (response.getBody().getFirstName() != null) {
      assertThat(response.getBody().getFirstName()).isEqualTo("UpdatedTest");
    }
  }
  ...
  void testUpdateUser_NotFound() {
    // Arrange - Use admin to update any user
    Long nonExistentId = 99999L;
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            baseUrl + "/users/" + nonExistentId, HttpMethod.PUT, request, String.class);
  ...
  void testSearchUsers_NoMatches() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            baseUrl + "/users/search?query=" + query, HttpMethod.GET, request, String.class);
  ...
  void testSearchUsers_DefaultPagination() {
    ...
    ResponseEntity<Void> response =
        restTemplate.exchange(
            baseUrl + "/users/search?query=" + query, HttpMethod.GET, request, Void.class);
  ...
  @Test
  @Order(16)
  @DisplayName("Should delete user successfully when authenticated as admin")
  void testDeleteUser_Success() {
    // Arrange - Create a user to delete
    java.util.Map<String, Object> userToDelete =
        createTestUserMap("deleteuser", "delete@example.com");
    ResponseEntity<UserDTO> createResponse =
        restTemplate.postForEntity(baseUrl + "/users", userToDelete, UserDTO.class);

    assertThat(createResponse.getStatusCode()).isEqualTo(HttpStatus.CREATED);
    assertThat(createResponse.getBody()).isNotNull();
    Long userIdToDelete = createResponse.getBody().getId();

    // Authenticate as admin (can delete any user)
    String token = authenticateAndGetToken("adminuser", "admin123");
    HttpHeaders headers = createAuthHeaders(token);
    HttpEntity<Void> request = new HttpEntity<>(headers);
    ...
    ResponseEntity<Void> response =
        restTemplate.exchange(
            baseUrl + "/users/" + userIdToDelete, HttpMethod.DELETE, request, Void.class);
    ...
    ResponseEntity<String> getResponse =
        restTemplate.exchange(
            baseUrl + "/users/" + userIdToDelete, HttpMethod.GET, request, String.class);
  ...
  void testDeleteUser_NotFound() {
    // Arrange - Use admin to delete any user
    Long nonExistentId = 99999L;
    String token = authenticateAndGetToken("adminuser", "admin123");
    HttpHeaders headers = createAuthHeaders(token);
    HttpEntity<Void> request = new HttpEntity<>(headers);
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            baseUrl + "/users/" + nonExistentId, HttpMethod.DELETE, request, String.class);
  ...
  void testFullUserLifecycle() throws Exception {
    // 1. CREATE
    java.util.Map<String, Object> newUser =
        createTestUserMap("lifecycleuser", "lifecycle@example.com");
    ResponseEntity<UserDTO> createResponse =
        restTemplate.postForEntity(baseUrl + "/users", newUser, UserDTO.class);
    assertThat(createResponse.getStatusCode()).isEqualTo(HttpStatus.CREATED);
    Long userId = createResponse.getBody().getId();

    // Use admin authentication for all operations (simplifies test)
    String token = authenticateAndGetToken("adminuser", "admin123");
    HttpHeaders headers = createAuthHeaders(token);
    ...
    ResponseEntity<String> getResponse =
        restTemplate.exchange(
            baseUrl + "/users/" + userId, HttpMethod.GET, getRequest, String.class);
    ...
    ResponseEntity<UserDTO> updateResponse =
        restTemplate.exchange(
            baseUrl + "/users/" + userId, HttpMethod.PUT, updateRequest, UserDTO.class);
    ...
    ResponseEntity<String> searchResponse =
        restTemplate.exchange(
            baseUrl + "/users/search?query=lifecycle", HttpMethod.GET, searchRequest, String.class);
    ...
    ResponseEntity<Void> deleteResponse =
        restTemplate.exchange(
            baseUrl + "/users/" + userId, HttpMethod.DELETE, deleteRequest, Void.class);
  ...
  void testAdminAccessToRoles() {
    ...
    // Act
    ResponseEntity<String> response =
        restTemplate.exchange(baseUrl + "/roles", HttpMethod.GET, request, String.class);
