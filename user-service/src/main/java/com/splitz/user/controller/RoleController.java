...
public class RoleController {
    ...
    @Operation(summary = "Get role by ID", description = "Returns details of a specific role by its ID. Restricted to ADMIN role.", responses = {
    ...
    @Operation(summary = "Get role by name", description = "Returns details of a specific role by its name. Restricted to ADMIN role.", responses = {
            @ApiResponse(responseCode = "200", description = "Role found", content = @Content(schema = @Schema(implementation = RoleDTO.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden - Admin role required", content = @Content),
            @ApiResponse(responseCode = "404", description = "Role not found", content = @Content)
    })
    ...
    // Get all roles
    @Operation(summary = "List all roles", description = "Returns a list of all available roles. Restricted to ADMIN role.", responses = {
    ...
    @Operation(summary = "Create a new role", description = "Creates a new user role. Restricted to ADMIN role.", responses = {
            @ApiResponse(responseCode = "201", description = "Role successfully created", content = @Content(schema = @Schema(implementation = RoleDTO.class))),
