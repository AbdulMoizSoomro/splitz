...
public class UserController {
    ...
    @Operation(summary = "Register a new user", description = "Creates a new user account. This is a public endpoint.", responses = {
    ...
    @Operation(summary = "List all users", description = "Returns a list of all registered users. Restricted to ADMIN role.", responses = {
    ...
    @Operation(summary = "Get user by ID", description = "Returns details of a specific user by their ID. Requires authentication.", responses = {
    ...
    @Operation(summary = "Update user", description = "Updates an existing user's details. Only the user themselves or an ADMIN can perform this action.", responses = {
            @ApiResponse(responseCode = "200", description = "User successfully updated", content = @Content(schema = @Schema(implementation = UserDTO.class))),
    ...
    @Operation(summary = "Delete user", description = "Deletes a user account. Only the user themselves or an ADMIN can perform this action.", responses = {
    ...
    @Operation(summary = "Search users", description = "Searches for users by name or email with pagination. Requires authentication.", responses = {
