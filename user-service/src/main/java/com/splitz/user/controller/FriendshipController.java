...
public class FriendshipController {
  ...
  @Operation(summary = "List pending requests", description = "Returns a list of all pending incoming friend requests for a user. "
      + "Only the user themselves or an ADMIN can perform this action.", responses = {
