...
@Tag(
    name = "Friendships",
    description = "Endpoints for managing user connections and friend requests")
public class FriendshipController {
  ...
  @Operation(
      ...
      description =
          "Sends a friend request from one user to another. Only the user themselves or an ADMIN can perform this action.",
      responses = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid request (e.g., friending self, duplicate request)",
            content = @Content),
        @ApiResponse(
            responseCode = "403",
  ...
  @Operation(
      ...
      description =
          "Returns a list of all accepted friends for a user. Only the user themselves or an ADMIN can perform this action.",
      responses = {
  ...
  @Operation(
      ...
      description =
          "Accepts a pending friend request. Only the addressee of the request or an ADMIN can perform this action.",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Rejects a pending friend request. Only the addressee of the request or an ADMIN can perform this action.",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Removes an existing friendship. Only the user themselves or an ADMIN can perform this action.",
      responses = {
