...
/**
 * DataInitializer ensures that default roles exist in the database on application startup. This is
 * a safety mechanism in addition to Flyway migrations.
 *
 * <p>Why both Flyway and DataInitializer? - Flyway V4 migration seeds roles for PostgreSQL
 * production databases - DataInitializer handles H2 in-memory databases and provides runtime safety
 */
@Configuration
